...
public class ThomasFaceBlock extends Block {
	public static final DirectionProperty FACING = HorizontalDirectionalBlock.FACING;
	private final ImmutableMap<BlockState, VoxelShape> shapes = this.makeShapes();

	public ThomasFaceBlock() {
		super(BlockBehaviour.Properties.of().sound(SoundType.METAL).instabreak().noCollission().isRedstoneConductor((bs, br, bp) -> false));
