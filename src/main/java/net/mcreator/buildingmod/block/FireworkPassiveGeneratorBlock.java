...
public class FireworkPassiveGeneratorBlock extends Block {
	public FireworkPassiveGeneratorBlock() {
	...
	public void animateTick(BlockState state, Level level, BlockPos pos, RandomSource random) {
		...
		PassiveGeneratorParticles.spawnSurface(level, pos, random, ParticleTypes.FLASH, 1, 2D, 0.1D);
	}
