...
public class SmallSmokePassiveGeneratorBlock extends Block {
	public SmallSmokePassiveGeneratorBlock() {
	...
	public void animateTick(BlockState state, Level level, BlockPos pos, RandomSource random) {
		...
		PassiveGeneratorParticles.spawnVolume(level, pos, random, ParticleTypes.SMOKE, 8, 0.5D);
	}
