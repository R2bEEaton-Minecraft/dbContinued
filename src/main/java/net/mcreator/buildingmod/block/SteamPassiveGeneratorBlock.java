...
public class SteamPassiveGeneratorBlock extends Block {
	public SteamPassiveGeneratorBlock() {
	...
	public void animateTick(BlockState state, Level level, BlockPos pos, RandomSource random) {
		...
		PassiveGeneratorParticles.spawnVolume(level, pos, random, ParticleTypes.CLOUD, 4, 0.1D);
	}
