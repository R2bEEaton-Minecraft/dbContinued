...
public class TntPassiveGeneratorBlock extends Block {
	public TntPassiveGeneratorBlock() {
	...
	public void animateTick(BlockState state, Level level, BlockPos pos, RandomSource random) {
		...
		PassiveGeneratorParticles.spawnVolume(level, pos, random, ParticleTypes.EXPLOSION, 8, 0.5D);
	}
